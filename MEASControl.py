...
class MeasControlGUI():
    def __init__(self, parent):
        ...
        self.rg6 = {'0A07': '34411A', '1A07': '34461A', '1301': '34461A', '1401': '34461A', '0101': '34465A', '0DAD':'V7-78/1',
        ...
        with open('{}\\setting.json'.format(self.folder_1),'r', encoding='utf-8') as file_json:
            self.sett_json = json.load(file_json)
        with open('{}\\theme.json'.format(self.folder_1),'r', encoding='utf-8') as file_json:
            self.theme_json = json.load(file_json)
        with open('{}\\language.json'.format(self.folder_1),'r', encoding='utf-8') as file_json:
    ...
    def protokol(self): 
        rep = filedialog.askopenfilenames(parent=self.parent, initialdir='{}\\Protocol\\'.format(self.folder_1), initialfile='',
    ...
    def about_win(self):
        ...
        _support_1_0 = tk.Label(top_2, justify='center', text=text2_0, font=('arial', 10, 'bold'), foreground='deepskyblue4').grid(row=0, column=0)
        _support_1_1 = tk.Label(top_2, justify='center', text=text2_1, font=('arial', 10, 'bold'), foreground='deepskyblue4').grid(row=0, column=1)
        _support_2 = tk.Label(top_3, text=text3, font=('arial', 10), foreground='deepskyblue4').grid(row=0, column=0)
        _support_3 = tk.Label(top_3, text=text4, font=('arial', 10), foreground='deepskyblue4').grid(row=0, column=1)
        _support_4 = tk.Label(top_3, text=text5, font=('arial', 10), foreground='deepskyblue4').grid(row=0, column=2)
        _support_5 = tk.Label(top_3, text=text6, font=('arial', 10), foreground='deepskyblue4').grid(row=0, column=3)
        _support_6 = tk.Label(top_3, text=text7, font=('arial', 10), foreground='deepskyblue4').grid(row=0, column=4)
    ...
    def setting_win(self):
        ...
        try:
            if self.a1[1] == '34420A':
                _c1 = tk.Checkbutton(self.top, text="Заглушка", variable=self.acv_var, onvalue=1, offvalue=0).pack(anchor='w')
                _c2 = tk.Checkbutton(self.top, text="Постоянное напряжение", variable=self.dcv_var, onvalue=1, offvalue=0).pack(anchor='w')
                _c3 = tk.Checkbutton(self.top, text="Сопротивление 4-провода", variable=self.r4_var, onvalue=1, offvalue=0).pack(anchor='w')
            elif self.a1[1] in ('34401A', '34410A', '34411A', '34460A', '34461A', '34465A', '34470A', 'V7-78/1'):
                _c1 = tk.Checkbutton(self.top, text="Постоянное напряжение", variable=self.dcv_var, onvalue=1, offvalue=0).pack(anchor='w')
                _c2 = tk.Checkbutton(self.top, text="Переменное напряжение", variable=self.acv_var, onvalue=1, offvalue=0).pack(anchor='w')
                _c3 = tk.Checkbutton(self.top, text="Частота", variable=self.f_var, onvalue=1, offvalue=0).pack(anchor='w')
                _c4 = tk.Checkbutton(self.top, text="Постоянный ток", variable=self.dci_var, onvalue=1, offvalue=0).pack(anchor='w')
                _c5 = tk.Checkbutton(self.top, text="Переменный ток", variable=self.aci_var, onvalue=1, offvalue=0).pack(anchor='w')
                _c6 = tk.Checkbutton(self.top, text="Ёмкость", variable=self.c_var, onvalue=1, offvalue=0).pack(anchor='w')
                _c7 = tk.Checkbutton(self.top, text="Сопротивление 2-провода", variable=self.r2_var, onvalue=1, offvalue=0).pack(anchor='w')
                _c8 = tk.Checkbutton(self.top, text="Сопротивление 4-провода", variable=self.r4_var, onvalue=1, offvalue=0).pack(anchor='w')
            elif self.a1[1] == 'WJ312A':
                _c1 = tk.Checkbutton(self.top, text="Постоянное напряжение", variable=self.dcv_var, onvalue=1, offvalue=0).pack(anchor='w')
                _c2 = tk.Checkbutton(self.top, text="Время нарастания", variable=self.tr_var, onvalue=1, offvalue=0).pack(anchor='w')
                _c3 = tk.Checkbutton(self.top, text="Период", variable=self.per_var, onvalue=1, offvalue=0).pack(anchor='w')
            elif self.a1[1] in ('TDS 1002B','TDS 1012B','TDS 2002B','TDS 2012B','TDS 2014B', 'TDS 2022B', 'TDS 2024B'):
                _c1 = tk.Checkbutton(self.top, text="Постоянное напряжение", variable=self.dcv_var, onvalue=1, offvalue=0).pack(anchor='w')
                _c2 = tk.Checkbutton(self.top, text="Временной интервал", variable=self.per_var, onvalue=1, offvalue=0).pack(anchor='w') 
                _c3 = tk.Checkbutton(self.top, text="Время нарастания", variable=self.tr_var, onvalue=1, offvalue=0).pack(anchor='w')              
    ...
    def set_style_win(self):
        ...
        def set_ok():
            ...
            with open('{}\\theme.json'.format(self.folder_1), 'w', encoding='utf-8') as file_json:
                json.dump(self.theme_json, file_json, ensure_ascii=False, indent=4, sort_keys=True)
            with open('{}\\setting.json'.format(self.folder_1), 'w', encoding='utf-8') as file_json:
    ...
    def connect_dmm(self):
        ...
        self.name_protokol.set('{},{},{}.xlsx'.format(self.data_today, self.name_a1, self.a1[2]))
        self.lab3['text'] = 'Тип: {}'.format(self.a1[1])
        self.lab4['text'] = 'Зав.№: {}'.format(self.a1[2])
    ...
    def connect_fluke_set(self):
        ...
        self.b10 = 'Калибратор {} {} подключен'.format(self.b1[0], self.b1[1])
    ...
    def connect_fluke_9500(self):
        ...
        self.query("++auto 1")
        self.query("++addr {}".format(self.spinbox1.get()))
        self.data_2 = self.query("*IDN?")
        self.connect_fluke_set()
        try:
            if self.b1[0] == 'Fluke':
                self.query("ROUT:SIGN:PATH CH{}".format(self.spinbox2.get()))
                self.data_2_1 = self.query("ROUT:FITT? CH{}".format(self.spinbox2.get()))
    ...
    def start(self):
        ...
        exec(open('{}\\file_py\\{}.py'.format(self.folder_1, self.name_a1), encoding='utf-8').read())            
...
class Call_oscill(Thread):
    ...
    def call_tds2(self):
        ...
        if self.vosc2 in ('MEASU:MEAS1:VAL?'):
            ...
            data_true = data_true * float('1E+{}'.format(tdiv_2[-1:]))
