...
for j in range(1,5,1):
    ...
    Call_oscill('VOLT 3.1', f'CH{j}:VOL 2\nTRIG:MAI:LEV -1.5', 'MEASU:MEAS4:VAL?', f'tr{j}_2', '', 2.1)
    Call_oscill('VOLT 3.1', f'CH{j}:VOL 1\nTRIG:MAI:LEV -1.5', 'MEASU:MEAS4:VAL?', f'tr{j}_3', '', 2.1)
    Call_oscill('VOLT 3', f'CH{j}:VOL 0.5\nTRIG:MAI:LEV -0.5', 'MEASU:MEAS4:VAL?', f'tr{j}_4', '', 2.1)
    ...
    Call_oscill('VOLT 0.3', f'CH{j}:VOL 0.05\nTRIG:MAI:LEV -0.05', 'MEASU:MEAS4:VAL?', f'tr{j}_7', '', 2.1)
    Call_oscill('VOLT 0.12', f'CH{j}:VOL 0.02\nTRIG:MAI:LEV -0.05', 'MEASU:MEAS4:VAL?', f'tr{j}_8', '', 2.1)
    Call_oscill('VOLT 0.06', f'CH{j}:VOL 0.01\nTRIG:MAI:LEV -0.03', 'MEASU:MEAS4:VAL?', f'tr{j}_9', '', 2.1)
    Call_oscill('VOLT 0.03', f'CH{j}:VOL 0.005\nTRIG:MAI:LEV -0.015', 'MEASU:MEAS4:VAL?', f'tr{j}_10', '', 2.1)
