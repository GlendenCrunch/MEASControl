...
#2 period
Param_wj312('3', 'ROUT:SIGN:IMP 50', 'SCOP:SHAP SIN', 'MLEN 500', 'TDIV 20ms')
Call_oscill('VOLT 0.6', 'C2: VDIV 100mv', 'MSRD?', 'frq_2', '', 100.0)
#3 dcv
Message('Подключите формирователь на второй канал осциллографа')
Param_wj312('3', 'ROUT:SIGN:IMP 1E+06', 'SCOP:SHAP DC', 'MLEN 500', 'TDIV 1ms')
Call_oscill('VOLT 0.015', 'C3: VDIV 5mv', 'MSRA?', 'dcv_25', 'gdcv_25', 2.425)
Call_oscill('VOLT -0.015', 'C3: VDIV 5mv', 'MSRB?', 'dcv_26', 'gdcv_26', 2.425)
Call_oscill('VOLT 0.03', 'C3: VDIV 10mv', 'MSRA?', 'dcv_27', 'gdcv_27', 2.85)
Call_oscill('VOLT -0.03', 'C3: VDIV 10mv', 'MSRB?', 'dcv_28', 'gdcv_28', 2.85)
Call_oscill('VOLT 0.3', 'C3: VDIV 100mv', 'MSRA?', 'dcv_29', 'gdcv_29', 10.5)
Call_oscill('VOLT -0.3', 'C3: VDIV 100mv', 'MSRB?', 'dcv_30', 'gdcv_30', 10.5)
Call_oscill('VOLT 1.5', 'C3: VDIV 500mv', 'MSRA?', 'dcv_31', 'gdcv_31', 44.5)
Call_oscill('VOLT -1.5', 'C3: VDIV 500mv', 'MSRB?', 'dcv_32', 'gdcv_32', 44.5)
Call_oscill('VOLT 3.0', 'C3: VDIV 1', 'MSRA?', 'dcv_33', 'gdcv_33', 87.0)
Call_oscill('VOLT -3.0', 'C3: VDIV 1', 'MSRB?', 'dcv_34', 'gdcv_34', 87.0)
Call_oscill('VOLT 30.0', 'C3: VDIV 10', 'MSRA?', 'dcv_35', 'gdcv_35', 852.0)
Call_oscill('VOLT -30.0', 'C3: VDIV 10', 'MSRB?', 'dcv_36', 'gdcv_36', 852.0)
#3 trise
Message('Подключите внешнию нагрузку 50 Ом на первый канал осциллографа')
Param_wj312('3', 'ROUT:SIGN:IMP 50', 'SCOP:SHAP EDGE', 'MLEN 50', 'TDIV 5ns')
Call_oscill('VOLT 0.5', '', 'MSRC?', 'tr_3', '', 3.5)
#3 period
Param_wj312('3', 'ROUT:SIGN:IMP 50', 'SCOP:SHAP SIN', 'MLEN 500', 'TDIV 20ms')
Call_oscill('VOLT 0.6', 'C3: VDIV 100mv', 'MSRD?', 'frq_3', '', 100.0)
#4 dcv
Message('Подключите формирователь на второй канал осциллографа')
Param_wj312('4', 'ROUT:SIGN:IMP 1E+06', 'SCOP:SHAP DC', 'MLEN 500', 'TDIV 1ms')
Call_oscill('VOLT 0.015', 'C4: VDIV 5mv', 'MSRA?', 'dcv_37', 'gdcv_37', 2.425)
Call_oscill('VOLT -0.015', 'C4: VDIV 5mv', 'MSRB?', 'dcv_38', 'gdcv_38', 2.425)
Call_oscill('VOLT 0.03', 'C4: VDIV 10mv', 'MSRA?', 'dcv_39', 'gdcv_39', 2.85)
Call_oscill('VOLT -0.03', 'C4: VDIV 10mv', 'MSRB?', 'dcv_40', 'gdcv_40', 2.85)
Call_oscill('VOLT 0.3', 'C4: VDIV 100mv', 'MSRA?', 'dcv_41', 'gdcv_41', 10.5)
Call_oscill('VOLT -0.3', 'C4: VDIV 100mv', 'MSRB?', 'dcv_42', 'gdcv_42', 10.5)
Call_oscill('VOLT 1.5', 'C4: VDIV 500mv', 'MSRA?', 'dcv_43', 'gdcv_43', 44.5)
Call_oscill('VOLT -1.5', 'C4: VDIV 500mv', 'MSRB?', 'dcv_44', 'gdcv_44', 44.5)
Call_oscill('VOLT 3.0', 'C4: VDIV 1', 'MSRA?', 'dcv_45', 'gdcv_45', 87.0)
Call_oscill('VOLT -3.0', 'C4: VDIV 1', 'MSRB?', 'dcv_46', 'gdcv_46', 87.0)
Call_oscill('VOLT 30.0', 'C4: VDIV 10', 'MSRA?', 'dcv_47', 'gdcv_47', 852.0)
Call_oscill('VOLT -30.0', 'C4: VDIV 10', 'MSRB?', 'dcv_48', 'gdcv_48', 852.0)
#4 trise
Message('Подключите внешнию нагрузку 50 Ом на первый канал осциллографа')
Param_wj312('4', 'ROUT:SIGN:IMP 50', 'SCOP:SHAP EDGE', 'MLEN 50', 'TDIV 5ns')
Call_oscill('VOLT 0.5', '', 'MSRC?', 'tr_4', '', 3.5)
#4 period
Param_wj312('4', 'ROUT:SIGN:IMP 50', 'SCOP:SHAP SIN', 'MLEN 500', 'TDIV 20ms')
Call_oscill('VOLT 0.6', 'C4: VDIV 100mv', 'MSRD?', 'frq_4', '', 100.0)
