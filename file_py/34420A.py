...
if self.vardict_boo['dcv_var'].get() == 1:
    ...
    Supportfunc('message-Соедините провода для измерения постоянного напряжения по КАНАЛУ 2 (зеленый(+)-белый(-))')
...
if self.vardict_boo['r4_var'].get() == 1:
    Supportfunc('message-Соедините провода по четырехпроводной схеме для измерения сопротивления (красный(+)-черный(-); зеленый(+)-белый(-))')
    ...
    Supportfunc('message-Соедините провода по двухпроводной схеме для измерения сопротивления (красный-зеленый(+); черный-белый(-))')
...
if self.vardict_boo['acv_var'].get() == 1:
    Supportfunc('message-Подключите заглушку')
