...
if self.vardict_boo['dcv_var'].get() == 1:
    ...
    Call('dcv', '-100 mV', 'CONF:VOLT:DC 0.1', 'dcv_2', '', 'DET:BAND 20', 3, 00.0085)
    Call('dcv', '1 V', 'CONF:VOLT:DC 1', 'dcv_3', '', 'DET:BAND 20', 3, 0.000047)
    Call('dcv', '-1 V', 'CONF:VOLT:DC 1', 'dcv_4', '', 'DET:BAND 20', 3, 0.000047)
    Call('dcv', '4 V', 'CONF:VOLT:DC 10', 'dcv_5', '', 'DET:BAND 20', 3, 0.00019)
    Call('dcv', '10 V', 'CONF:VOLT:DC 10', 'dcv_6', '', 'DET:BAND 20', 3, 0.0004)
    Call('dcv', '-10 V', 'CONF:VOLT:DC 10', 'dcv_7', '', 'DET:BAND 20', 3, 0.0004)
    Call('dcv', '100 V', 'CONF:VOLT:DC 100', 'dcv_8', '', 'DET:BAND 20', 4, 0.0051)
    Call('dcv', '-100 V', 'CONF:VOLT:DC 100', 'dcv_9', '', 'DET:BAND 20', 4, 0.0051)
    Call('dcv', '1000 V', 'CONF:VOLT:DC 1000', 'dcv_10', '', 'DET:BAND 20', 8, 0.055)
    Call('dcv', '-500 V', 'CONF:VOLT:DC 1000', 'dcv_11', '', 'DET:BAND 20', 8, 0.0325)
if self.vardict_boo['acv_var'].get() == 1:
    Call('acv', '100 mV, 1 kHz', 'CONF:VOLT:AC 0.1', 'acv_1', '', 'DET:BAND 20', 5, 0.09)
    Call('acv', '100 mV, 50 kHz', 'CONF:VOLT:AC 0.1', 'acv_2', '', 'DET:BAND 20', 5, 0.17)
    Call('acv', '100 mV, 300 kHz', 'CONF:VOLT:AC 0.1', 'acv_3', '', 'DET:BAND 20', 5, 4.5)
    Call('acv', '1 V, 1 kHz', 'CONF:VOLT:AC 1', 'acv_4', '', 'DET:BAND 20', 5, 0.0009)
    ...
    Call('acv', '1 V, 1 kHz', 'CONF:VOLT:AC 10', 'acv_8', '', 'DET:BAND 20', 5, 0.0036)
    Call('acv', '10 V, 10 Hz', 'CONF:VOLT:AC 10', 'acv_9', '', 'DET:BAND 3', 5, 0.009)
    Call('acv', '10 V, 100 Hz', 'CONF:VOLT:AC 10', 'acv_10', '', 'DET:BAND 20', 5, 0.009)
    Call('acv', '10 V, 20 kHz', 'CONF:VOLT:AC 10', 'acv_11', '', 'DET:BAND 20', 5, 0.009)
    Call('acv', '10 V, 50 kHz', 'CONF:VOLT:AC 10', 'acv_12', '', 'DET:BAND 20', 5, 0.02)
    Call('acv', '10 V, 100 kHz', 'CONF:VOLT:AC 10', 'acv_13', '', 'DET:BAND 20', 5, 0.068)
    Call('acv', '100 V, 1 kHz', 'CONF:VOLT:AC 100', 'acv_15', '', 'DET:BAND 20', 5, 0.09)
    Call('acv', '750 V, 1 kHz', 'CONF:VOLT:AC 750', 'acv_18', '', 'DET:BAND 20', 5, 0.7)
    if self.b1[1] == '5522A':
        ...
        Call('acv', '210 V, 50 kHz', 'CONF:VOLT:AC 750', 'acv_19', '', 'DET:BAND 20', 5, 0.63)
...
if self.vardict_boo['f_var'].get() == 1:
    ...
    Call('fr', '0.01 V, 300 kHz', 'CONF:FREQ 300 kHz', 'f_2', '', 'DET:BAND 20', 5, 0.3)
if self.vardict_boo['r2_var'].get() == 1:
    Call('res', '1 MOHM; ZCOMP WIRE2', 'CONF:RES 1 MOHM', 'r2_1', '', 'DET:BAND 20', 5, 0.00011)
...
if self.vardict_boo['r4_var'].get() == 1:
    ...
    Call('res', '100 OHM', 'CONF:FRES 100', 'r4_1', '', 'DET:BAND 20', 5, 0.014)
    Call('res', '1 kOHM', 'CONF:FRES 1 KOHM', 'r4_2', '', 'DET:BAND 20', 5, 0.00011)
    Call('res', '10 kOHM', 'CONF:FRES 10 KOHM', 'r4_3', '', 'DET:BAND 20', 5, 0.0011)
    Call('res', '100 kOHM', 'CONF:FRES 100 KOHM', 'r4_4', '', 'DET:BAND 20', 5, 0.011)
...
if self.vardict_boo['aci_var'].get() == 1:
    ...
    Call('aci', '100 mA, 10 Hz', 'CONF:CURR:AC 0.1', 'aci_9', '', 'DET:BAND 3', 8, 0.14)
    Call('aci', '100 mA, 1 kHz', 'CONF:CURR:AC 0.1', 'aci_10', '', 'DET:BAND 20', 5, 0.14)
    Call('aci', '100 mA, 5 kHz', 'CONF:CURR:AC 0.1', 'aci_11', '', 'DET:BAND 20', 5.0, 0.14)
...
if self.vardict_boo['dci_var'].get() and self.vardict_boo['aci_var'].get() == 1:
    Message('Подключите провода\n для измерения тока больше 3 Ампер')
    Reset()
    Call('dci', '5 A', 'CONF:CURR:DC 10', 'dci_7', '', 'DET:BAND 20', 5, 0.012)
    Call('dci', '10 A', 'CONF:CURR:DC 10', 'dci_8', '', 'DET:BAND 20', 5, 0.022)
    if self.b1[1] == '5522A':
        Call('aci', '10 A, 5 kHz', 'CONF:CURR:AC 10', 'aci_16', '', 'DET:BAND 20', 5, 0.19)
