...
for j in range(1,5,1):
    ...
    Call_oscill('VOLT 0.01', f'C{j}:VDIV 0.002', f'C{j}:PAVA? RMS', f'bw{j}_1', 'FREQ:FIX 50E+03', 100)
    Call_oscill('VOLT 0.03', f'C{j}:VDIV 0.005', f'C{j}:PAVA? RMS', f'bw{j}_2', 'FREQ:FIX 50E+03', 100)
    Call_oscill('VOLT 0.06', f'C{j}:VDIV 0.01', f'C{j}:PAVA? RMS', f'bw{j}_3', 'FREQ:FIX 50E+03', 100)
    Call_oscill('VOLT 0.12', f'C{j}:VDIV 0.02', f'C{j}:PAVA? RMS', f'bw{j}_4', 'FREQ:FIX 50E+03', 100)
    Call_oscill('VOLT 0.3', f'C{j}:VDIV 0.05', f'C{j}:PAVA? RMS', f'bw{j}_5', 'FREQ:FIX 50E+03', 100)
    Call_oscill('VOLT 0.6', f'C{j}:VDIV 0.1', f'C{j}:PAVA? RMS', f'bw{j}_6', 'FREQ:FIX 50E+03', 100)
    Call_oscill('VOLT 1.2', f'C{j}:VDIV 0.2', f'C{j}:PAVA? RMS', f'bw{j}_7', 'FREQ:FIX 50E+03', 100)
    Call_oscill('VOLT 3', f'C{j}:VDIV 0.5', f'C{j}:PAVA? RMS', f'bw{j}_8', 'FREQ:FIX 50E+03', 100)
    Call_oscill('VOLT 5.5', f'C{j}:VDIV 1', f'C{j}:PAVA? RMS', f'bw{j}_9', 'FREQ:FIX 50E+03', 100)
    Call_oscill('VOLT 5.5', f'C{j}:VDIV 2', f'C{j}:PAVA? RMS', f'bw{j}_10', 'FREQ:FIX 50E+03', 100)
    Call_oscill('VOLT 5.5', f'C{j}:VDIV 5', f'C{j}:PAVA? RMS', f'bw{j}_11', 'FREQ:FIX 50E+03', 100)
    # trise
    ...
    Call_oscill('VOLT 0.01', f'C{j}:VDIV 0.002', f'C{j}:PAVA? RISE', f'tr{j}_1', '0.005', 3.5)
    Call_oscill('VOLT 0.03', f'C{j}:VDIV 0.005', f'C{j}:PAVA? RISE', f'tr{j}_2', '0.014', 3.5)
    Call_oscill('VOLT 0.06', f'C{j}:VDIV 0.01', f'C{j}:PAVA? RISE', f'tr{j}_3', '0.03', 3.5)
    Call_oscill('VOLT 0.11', f'C{j}:VDIV 0.02', f'C{j}:PAVA? RISE', f'tr{j}_4', '0.06', 3.5)
    Call_oscill('VOLT 0.27', f'C{j}:VDIV 0.05', f'C{j}:PAVA? RISE', f'tr{j}_5', '0.15', 3.5)
    Call_oscill('VOLT 0.55', f'C{j}:VDIV 0.1', f'C{j}:PAVA? RISE', f'tr{j}_6', '0.3', 3.5)
    Call_oscill('VOLT 1.2', f'C{j}:VDIV 0.2', f'C{j}:PAVA? RISE', f'tr{j}_7', '0.6', 3.5)
    Call_oscill('VOLT 2.7', f'C{j}:VDIV 0.5', f'C{j}:PAVA? RISE', f'tr{j}_8', '1.5', 3.5)
    Call_oscill('VOLT 3.1', f'C{j}:VDIV 1', f'C{j}:PAVA? RISE', f'tr{j}_9', '3', 3.5)
